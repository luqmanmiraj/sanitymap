...
const Header = () => {
  ...
  return (
    <>
          ...
          <div className="container mx-auto h-full flex flex-col justify-center items-center px-4 py-6">
            ...
            <nav className="flex flex-col justify-center items-center w-full max-w-md">
              <div className="bg-[#A3A3A34D] bg-opacity-30 backdrop-blur-md rounded-full flex justify-center w-full max-w-[386px] h-[70px] mt-[30px] sm:h-[60px] border border-[#BDBDBD66] p-2 sm:p-1">
                <button onClick={toggleModal} className="text-white px-4 flex-grow font-['var(--FontFamilyParagraph)'] text-[18px] sm:text-[14px] lg:text-[20px] leading-[18px] text-center flex items-center justify-center hover:bg-opacity-50 focus:bg-white focus:text-black focus:outline-none rounded-full h-full">When</button>
                <button className="text-white px-4 flex-grow font-['var(--FontFamilyParagraph)'] text-[18px] sm:text-[14px] lg:text-[20px] leading-[18px] text-center flex items-center justify-center hover:bg-opacity-50 focus:bg-white focus:text-black focus:outline-none rounded-full h-full">Who</button>
                <button className="text-white px-4 flex-grow font-['var(--FontFamilyParagraph)'] text-[18px] sm:text-[14px] lg:text-[20px] leading-[18px] text-center flex items-center justify-center hover:bg-opacity-50 focus:bg-white focus:text-black focus:outline-none rounded-full h-full">More +</button>
              </div>
            </nav>
          </div>
        </div>
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50" style={{ marginTop: '-170px' }}>
          <div className="bg-white w-[580px] h-[265px] p-4 pb-8 rounded-2xl border border-white relative">
            ...
            <div className="bg-[#E0E0E1] bg-opacity-30 backdrop-blur-md rounded-full flex justify-center items-center w-full max-w-[300px] h-[70px] mt-[30px] sm:h-[60px] border border-[#BDBDBD66] p-2 sm:p-1 mx-auto">
                <button className="text-black px-4 flex-grow font-['var(--FontFamilyParagraph)'] text-[18px] sm:text-[14px] lg:text-[20px] leading-[18px] text-center flex items-center justify-center hover:bg-opacity-50 focus:bg-[#FFFFFF] focus:text-black focus:outline-none rounded-full h-full">Seasons</button>
                <button className="text-black px-4 flex-grow font-['var(--FontFamilyParagraph)'] text-[18px] sm:text-[14px] lg:text-[20px] leading-[18px] text-center flex items-center justify-center hover:bg-opacity-50 focus:bg-[#FFFFFF] focus:text-black focus:outline-none rounded-full h-full">Months</button>
                <button className="text-black px-4 flex-grow font-['var(--FontFamilyParagraph)'] text-[18px] sm:text-[14px] lg:text-[20px] leading-[18px] text-center flex items-center justify-center hover:bg-opacity-50 focus:bg-[#FFFFFF] focus:text-black focus:outline-none rounded-full h-full">Dates</button>
              </div>
            <div className="flex justify-center gap-8 mt-8">
              <a href="#" className="flex flex-col items-center">
                <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
                  <rect width="64" height="64" rx="32" fill="#889D1E"/>
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M32.9264 20.3743C32.8208 20.2722 32.7024 20.1909 32.5763 20.1305C32.3944 20.0434 32.1971 20 32 20C31.6653 20 31.331 20.1254 31.0737 20.3743C28.6382 22.7018 27.1232 25.7968 26.7529 29.097C24.3718 27.5236 21.5634 26.6667 18.6667 26.6667C17.9303 26.6667 17.3334 27.2636 17.3334 28C17.3334 36.1002 23.8999 42.6667 32 42.6667C40.1002 42.6667 46.6667 36.1002 46.6667 28C46.6667 27.2636 46.0698 26.6667 45.3334 26.6667C42.3449 26.6667 39.5652 27.5605 37.247 29.0953C36.8763 25.7958 35.3614 22.7014 32.9264 20.3743ZM32 23.2852C30.158 25.5071 29.1995 28.352 29.345 31.2668C29.3453 31.2712 29.3455 31.2755 29.3456 31.2799C30.4469 32.4496 31.3391 33.782 31.9981 35.219C32.6674 33.7616 33.5686 32.4328 34.6544 31.2798L34.655 31.2668C34.8006 28.352 33.8421 25.5071 32 23.2852ZM30.5829 39.9172C30.2667 37.2562 29.0661 34.7621 27.152 32.8481C25.2379 30.934 22.7438 29.7333 20.0828 29.4171C20.7293 34.9119 25.0881 39.2707 30.5829 39.9172ZM43.9174 29.416C38.4217 30.062 34.0621 34.4217 33.416 39.9173C38.9117 39.2713 43.2713 34.9117 43.9174 29.416Z" fill="white"/>
                </svg>
              ...
              <a href="#" className="flex flex-col items-center">
                <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd" d="