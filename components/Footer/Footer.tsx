    ...
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="text-sm hover:underline">Our COVID-19 Response</a></li>
          </ul>
        </div>
        <div>
          <h3 className="text-sm font-bold mb-4">Community</h3>
          <ul className="space-y-2">
            <li><a href="#" className="text-sm hover:underline">Diversity & Belonging</a></li>
            <li><a href="#" className="text-sm hover:underline">Accessibility</a></li>
            <li><a href="#" className="text-sm hover:underline">Frontline Stays</a></li>
            <li><a href="#" className="text-sm hover:underline">Guest Referrals</a></li>
          </ul>
        </div>
        <div>
          <h3 className="text-sm font-bold mb-4">Hosting</h3>
          <ul className="space-y-2">
            <li><a href="#" className="text-sm hover:underline">Try hosting</a></li>
            <li><a href="#" className="text-sm hover:underline">AirCover: protection for Hosts</a></li>
            <li><a href="#" className="text-sm hover:underline">Explore hosting resources</a></li>
            <li><a href="#" className="text-sm hover:underline">Visit our community forum</a></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="text-sm hover:underline">Learn about new features</a></li>
            <li><a href="#" className="text-sm hover:underline">Letter from our founders</a></li>
      ...
      <div className="mt-8 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4">
          <p className="text-sm">&copy; 2023 Your Company Name, Inc.</p>
